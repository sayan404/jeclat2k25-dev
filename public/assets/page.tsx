...
// Import SVG icons
import AboutIcon from "@/app/assets/pic_1.svg";
import EventsIcon from "@/app/assets/pic_2.svg";
import SocialIcon from "@/app/assets/pic_3.svg";
import ArchiveIcon from "@/app/assets/pic_4.svg";
import TeamIcon from "@/app/assets/pic_5.svg";
import ContactIcon from "@/app/assets/pic_6.svg";
import MerchandiseIcon from "@/app/assets/pic_7.svg";
...
const links = [
  {
    ...
    href: "/about",
    icon: (
      <div className="w-12 h-12 md:w-16 md:h-16 text-cyan-400 flex items-center justify-center">
        <Image
    ...
    >
      {links.map((link) => (
        <motion.a
          ...
          className="relative flex flex-col items-center text-center group z-50 py-5 px-4
        ...
        >
          ...
          <span className="mt-3 text-[12px] md:text-sm uppercase text-cyan-400 font-bold group-hover:underline">
            {link.text}
          </span>
        </motion.a>
      ))}
